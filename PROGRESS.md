...
- **`tests/Characterization/Database/SchemaBackportMigrationsCharacterizationTest.php`**
...
- **`tests/Characterization/Database/SchemaBackportMigrationsCharacterizationTest.php`** — 3 nuovi test: sessions indexes, tokenactions basic indexes, conditional column indexes.
...
**ROADMAP cleanup:** marked all the reference application Schema Backport Tasks as `[x]` — migrations 000020–000048 cover all authserver/applications/public schema items.
...
- **Fix B:** `SchemaBackportMigrationsCharacterizationTest`: `connect(true)` → `connect(false)` με try-catch ώστε failed connection = skip (όχι RuntimeException)
...
**Testable Subclass pattern από the reference application εφαρμόστηκε στο framework** για όλα τα backported Console/Queue features:
...
## 🏁 Session 77 — the reference application Schema Backport: Complete Migration Audit & Implementation (2026-05-14)
...
- SchemaBackportMigrationsCharacterizationTest.php: 550+ lines
...
- docs/1.2-new-features.md: new section "the reference application Schema Backport — Phase 2"
...
- `c161469` test(characterization): add tests for the reference application backport migrations
- `9b9700d` docs: update audit and feature docs with complete the reference application schema backport
...
## 🏁 Session 69 — the reference application Backports: OAuthPolicyHelper, Scopes, Helpers, Scaffolding Views (2026-05-12)

### Ολοκληρώθηκε
- **`OAuthPolicyHelper`** (`src/Pramnos/Auth/OAuthPolicyHelper.php`) — added `getAuthenticationMethods()`, `getGrantTypes()`, `getWebhookTypes()` descriptive registries backported from the reference application `PermissionHelper`
...
- [x] **`Pramnos\Console\DaemonOrchestrator`** (`src/Pramnos/Console/DaemonOrchestrator.php`) — abstract process supervisor backported from the reference application:
...
- [x] **`Pramnos\Console\CommandBase`** (`src/Pramnos/Console/CommandBase.php`) — backport of `App\ConsoleCommands\CommandBase`:
