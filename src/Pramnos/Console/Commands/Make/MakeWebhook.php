 ...
 *   php pramnos project:git-webhook --force         # overwrite existing file
 *   php pramnos project:git-webhook --branch=main   # pre-fill the branch name in the stub
 */
class MakeWebhook extends MakeCommandBase
{
    protected function configure(): void
    {
        $this->setName('project:git-webhook');
 ...
 *
 * Generated by: php {$cliName} project:git-webhook
 */
