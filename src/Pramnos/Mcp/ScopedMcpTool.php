 ...
 *
 * The internal MCP server exposes nineteen tools that read coverage reports, run the code-style
 ...
 * and remote: a developer adds a nineteenth tool, and it is reachable over HTTP before anybody
