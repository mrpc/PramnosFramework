...
class MigrationRunnerPostgreSQLTest extends TestCase
{
     ...
     * the reference application base columns (when, key, extra) plus logging columns
    ...
    {
        // Arrange – create a minimal legacy table mimicking the old the reference application schema
