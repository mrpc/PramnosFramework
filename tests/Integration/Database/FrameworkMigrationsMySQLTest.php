...
class FrameworkMigrationsMySQLTest extends TestCase
{
     ...
     * the reference application), the roles table must use that column name instead of the
     ...
     * 'deyaid' for the reference application), the user_organizations migration must use that
     ...
     * unique constraint name to match the reference application.
     */
    public function testLoginlockoutsCreatedInAuthserverPrefixOnMySQL(): void
    {
        ...
        // Assert — unique constraint uses the reference application-aligned name
     ...
     * Column names are share_usage_analytics + marketing_emails (the reference application-aligned).
     */
    public function testUserPrivacySettingsCreatedInAuthserverPrefixOnMySQL(): void
    {
        ...
        // Assert — the reference application-aligned column names
        $this->assertTrue(
        ...
        $this->assertFalse(
            ...
            'data_processing must not exist (removed to match the reference application)'
        );
