...
/**
 * Characterization tests for new the reference application schema backport migrations.
 *
...
#[Group('migrations')]
class SchemaBackportMigrationsCharacterizationTest extends TestCase
{
     ...
     *
     * These indexes are present in the reference production schema but were absent
     ...
     * tokenactions indexes (tokenid and urlid) that were in the original the reference application
