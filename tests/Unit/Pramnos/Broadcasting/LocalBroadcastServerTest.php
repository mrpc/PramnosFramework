...
class LocalBroadcastServerTest extends TestCase
{
    ...
    // =========================================================================
    // Frame parsing moved out
    // =========================================================================
    //
    // The parseFrame() boundary cases that used to be reflected into from here
    // now live in tests/Unit/Pramnos/Http/WebSocket/FrameCodecTest.php, because
    // the framing itself moved to \Pramnos\Http\WebSocket\FrameCodec — one
    // implementation shared with the outbound WebSocketClient instead of one per
    // direction. That suite covers every branch these five tests covered and adds
    // the ones a private method could not be asked about: an oversized payload,
    // a fragmented control frame, and every incomplete prefix of a frame rather
