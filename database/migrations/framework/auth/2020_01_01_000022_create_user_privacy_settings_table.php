 ...
 * `id` to match reference production and simplify cross-table references.
 *
 * Columns: share_usage_analytics, marketing_emails (boolean, default false).
 * The old `data_processing` column was removed — it does not exist in the reference application.
 *
