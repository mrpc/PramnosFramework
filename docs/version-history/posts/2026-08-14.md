...
`DELETE`, not `TRUNCATE` — [measured last time](2026-08-14.md#truncate-is-slower-than-dropping-the-table),
...
[the container work](2026-08-14.md#the-test-database-was-afraid-of-losing-data) already
predicted:
...
They kept the cue filter the [entry-id fix](2026-08-14.md#the-ingest-dropped-the-id-it-had-just-read)
...
[GDPR and CSP concern](2026-08-14.md#minor-variable-name-changes) about three defaults pointing at
