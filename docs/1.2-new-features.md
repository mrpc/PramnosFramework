...
```php
// app/Config/app.php
'migration_cutoff' => '2024-01-01 00:00:00',
```

Any migration with a filename timestamp at or before this date is skipped. Used to prevent framework migrations that were already applied manually from being re-run on existing installations.
