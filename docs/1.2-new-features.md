...
// QR code provisioning URL for display to the user
...
// Returns: ['secret', 'qr_code_url', 'manual_entry_key', 'backup_codes']
...
Common keys: `type`, `db_size_bytes`, `connections_total`, `connections_active`, `cache_hit_ratio`.
