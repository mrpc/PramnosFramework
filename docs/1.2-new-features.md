...
- [11. Phase 4: Feature Registry](#11-phase-4-feature-registry)
- [12. Phase 4: Service Providers](#12-phase-4-service-providers)
- [13. Phase 4: Health Check & Observability](#13-phase-4-health-check-observability)
- [14. Phase 4: Scheduled Tasks System](#14-phase-4-scheduled-tasks-system)
- [15. Phase 4: Policy Engine](#15-phase-4-policy-engine)
...
- [24. Phase 3: Developer Experience — Scaffolding System](#24-phase-3-developer-experience-scaffolding-system)
- [25. Phase 2: Event / Hook System](#25-phase-2-event-hook-system)
- [26. Phase 2: CLI UX — CommandBase](#26-phase-2-cli-ux-commandbase)
- [28. Phase 2: Queue System — QueueManager, Worker, ProcessQueue](#28-phase-2-queue-system-queuemanager-worker-processqueue)
- [27. Phase 2: DaemonOrchestrator — Generic Process Supervisor](#27-phase-2-daemonorchestrator-generic-process-supervisor)
- [28. Phase 3: Migration Wizard & Seeder Generator](#28-phase-3-migration-wizard-seeder-generator)
- [29. Phase 2: db:seed CLI Command](#29-phase-2-dbseed-cli-command)
- [30. Phase 2: Token Action Tracking — Token::updateAction() & Sync Trigger](#30-phase-2-token-action-tracking-tokenupdateaction-sync-trigger)
- [31. Phase 2: OAuth Server — league/oauth2-server Integration](#31-phase-2-oauth-server-leagueoauth2-server-integration)
- [32. Phase 2: Messaging System — Models & Service Provider](#32-phase-2-messaging-system-models-service-provider)
- [33. Phase 2: Auth — Pramnos\Auth\Loginlockout](#33-phase-2-auth-pramnosauthloginlockout)
- [34. Phase 2: Auth — Pramnos\Auth\TOTPHelper + Pramnos\Auth\TwoFactorAuthService](#34-phase-2-auth-pramnosauthtotphelper-pramnosauthtwofactorauthservice)
- [35. Phase 2: Auth — Pramnos\Auth\Scopes + Pramnos\Auth\OAuthPolicyHelper](#35-phase-2-auth-pramnosauthscopes-pramnosauthoauthpolicyhelper)
- [36. Phase 2: Auth — GDPR Database Migrations](#36-phase-2-auth-gdpr-database-migrations)
- [37. Phase 2: AuthServer — RBAC Schema Migrations (Completion)](#37-phase-2-authserver-rbac-schema-migrations-completion)
- [38. Phase 2: Auth — Pramnos\Auth\WebhookService](#38-phase-2-auth-pramnosauthwebhookservice)
- [39. Auth Controllers — Pramnos\Auth\Controllers\*](#39-auth-controllers-pramnosauthcontrollers)
- [40. Pramnos\Auth\Controllers\Oauth](#40-pramnosauthcontrollersoauth)
- [41. Pramnos\Auth\Controllers\Device](#41-pramnosauthcontrollersdevice)
- [42. Pramnos\Auth\Controllers\Dashboard](#42-pramnosauthcontrollersdashboard)
- [35. 2FA View Templates (Scaffolding)](#35-2fa-view-templates-scaffolding)
- [43. Phase 5 QA Coverage — Complete](#43-phase-5-qa-coverage-complete)
- [44. Phase 6: PSR Compliance Layer](#44-phase-6-psr-compliance-layer)
- [45. Phase 9: Full ORM Layer](#45-phase-9-full-orm-layer)
- [46. Phase 7 — Modern Routing Engine](#46-phase-7-modern-routing-engine)
- [47. Phase 10 — File Storage Abstraction (Pramnos\Storage\)](#47-phase-10-file-storage-abstraction-pramnosstorage)
- [48. Validation Layer — Extended Rules & Custom Rules](#48-validation-layer-extended-rules-custom-rules)
- [49. HTTP Client — Pramnos\Http\Client](#49-http-client-pramnoshttpclient)
- [50. Faker — Pramnos\Support\Faker](#50-faker-pramnossupportfaker)
- [51. Factory — Pramnos\Database\Factory](#51-factory-pramnosdatabasefactory)
- [52. Seeder — Pramnos\Database\Seeder (updated)](#52-seeder-pramnosdatabaseseeder-updated)
- [53. Template Engine — Blade-inspired directives for views](#53-template-engine-blade-inspired-directives-for-views)
- [54. OAuth2 Policy Helper — Descriptive Registries](#54-oauth2-policy-helper-descriptive-registries)
- [55. Scopes — addDefaultScopesToToken()](#55-scopes-adddefaultscopestotoken)
- [56. Helpers — Coordinate and IP Validation](#56-helpers-coordinate-and-ip-validation)
- [57. Scaffolding — Auth Views for All Themes](#57-scaffolding-auth-views-for-all-themes)
- [58. ScaffoldingHelper — Pramnos\Application\ScaffoldingHelper](#58-scaffoldinghelper-pramnosapplicationscaffoldinghelper)
- [59. Controller — Scaffolding View Fallback](#59-controller-scaffolding-view-fallback)
- [61. Cache System — Phase 11 Completion](#61-cache-system-phase-11-completion)
- [60. scaffold:views — Incremental View Publishing](#60-scaffoldviews-incremental-view-publishing)
- [Advanced Schema Elements — Phase 2](#advanced-schema-elements-phase-2)
- [62. View & Template System — Complete Guide](#62-view-template-system-complete-guide)
- [45. Phase 20: HTTP Testing Infrastructure](#45-phase-20-http-testing-infrastructure)
...
- [68. SPA-style Auth — Session Cookie as API Credential (Phase 16)](#68-spa-style-auth-session-cookie-as-api-credential-phase-16)
- [69. Universal List API & Widget-agnostic Data Grid (Phase 17)](#69-universal-list-api-widget-agnostic-data-grid-phase-17)
...
- [Phase 25.3 — MD5 Legacy Password Support with Auto-Upgrade](#phase-253-md5-legacy-password-support-with-auto-upgrade)
- [Phase 25.2 — DatabaseAuthDriver: Native Authentication (No Addon Required)](#phase-252-databaseauthdriver-native-authentication-no-addon-required)
- [Phase 25.5 — SessionTrackingMiddleware + BotDetector](#phase-255-sessiontrackingmiddleware-botdetector)
- [Phase 25.4 — Built-in Login/Logout Lifecycle](#phase-254-built-in-loginlogout-lifecycle)
- [Phase 25.6 — Warning When No Auth Handlers Are Registered](#phase-256-warning-when-no-auth-handlers-are-registered)
- [Phase 24 — Navigation Registry (NavRegistry)](#phase-24-navigation-registry-navregistry)
- [Phase 23 — Framework Admin CRUD Controllers](#phase-23-framework-admin-crud-controllers)
- [Phase 23.11 — Statistics & Analytics Dashboard](#phase-2311-statistics-analytics-dashboard)
- [Phase 13: MCP Server — AI Developer Tooling](#phase-13-mcp-server-ai-developer-tooling)
- [§66 — Debug Toolbar (Phase 13)](#66-debug-toolbar-phase-13)
- [§67 — DevPanel: Developer / Admin Dashboard (Phase 14)](#67-devpanel-developer-admin-dashboard-phase-14)
- [§68 — GitInfo: Pure-PHP Git Reader (Phase 14)](#68-gitinfo-pure-php-git-reader-phase-14)
- [§69 — HealthController (web health dashboard + JSON endpoint)](#69-healthcontroller-web-health-dashboard-json-endpoint)
- [§70 — Broadcasting System (Phase 12)](#70-broadcasting-system-phase-12)
- [§71 — WebhookHandler (Phase 15)](#71-webhookhandler-phase-15)
- [§72 — API Documentation Scaffolding (Phase 18)](#72-api-documentation-scaffolding-phase-18)
...
- [Phase 21 — Advanced DX: Form Requests](#phase-21-advanced-dx-form-requests)
- [Phase 21 — Advanced DX: Model Factories](#phase-21-advanced-dx-model-factories)
- [Phase 21 — Advanced DX: Notification Channels](#phase-21-advanced-dx-notification-channels)
- [72. PF-40 — Client-side Group-by in Pramnos\Html\Datatable](#72-pf-40-client-side-group-by-in-pramnoshtmldatatable)
- [§73 — Scaffolding improvements (Session 145)](#73-scaffolding-improvements-session-145)
- [§74 — QR code local generation, DataTable JS fix, "View" link (Session 146)](#74-qr-code-local-generation-datatable-js-fix-view-link-session-146)
- [§74 — DebugBar enhancements (Session 148)](#74-debugbar-enhancements-session-148)
- [§75 — Database::pgRewriteDmlLimit — PostgreSQL DML LIMIT rewrite (Session 149)](#75-databasepgrewritedmllimit-postgresql-dml-limit-rewrite-session-149)
- [§76 — Removed legacy Factory accessors (BC note)](#76-removed-legacy-factory-accessors-bc-note)
- [§77 — Bugfix: Model::_ensurePrimaryKeyInSelect — ambiguous PK column in JOINs](#77-bugfix-model_ensureprimarykeyinselect-ambiguous-pk-column-in-joins)
- [§78 — Bugfix: log date filtering (JSON newline + non-slash date styles)](#78-bugfix-log-date-filtering-json-newline-non-slash-date-styles)
...
<a id="2-connection-health--auto-reconnect"></a>
...
<a id="3-databasecapabilities--runtime-detection"></a>
...
<a id="5-grammar--adapter-pattern"></a>
...
Two capabilities added to align with the Schema-Builder Spec, usable in `ifCapable()` calls:
...
### Migration-support helpers (added for framework migrations)

The following public methods were added to expose the migration API cleanly to `Migration` subclasses and to align with the Schema-Builder Spec's calling convention.
...
Alias for `alterTable()`. Matches the Laravel `Schema::table()` calling convention used in framework migrations.
...
Alias for `->constraintName()`. Matches the Schema-Builder Spec's `->name()` chaining style.
...
<a id="7-timebucket--dialect-transparent-time-bucketing"></a>
...
| `hasPendingFromSlugs(array $slugTimestamps, string $cutoff = '')` | Fast slug-based pending check without loading PHP files. |
...
```php
// app/Config/app.php  (or settings table)
'migration_cutoff' => '2020_01_02_000000',
```
...
migration system (e.g. reference production, which set up those same structures via its
...
|---|---|---|
| `getFrameworkMigrationDirs(): string[]` | `glob(frameworkBase/*)` | Add project-specific dirs |
| `getMigrationHistoryTable(): string` | `'schemaversion'` | Isolate test runs |
...
been wired up yet (expected during Phase 4 before Phase 2 features land).
...
- All currently registered built-in features (`core`, `auth`, `authserver`,
  ...
  will be instantiated for them until Phase 2 features are implemented.
...
All schemas match the reference production database. Schema comments in the
...
<a id="19-phase-4-centralized-error--exception-handler"></a>
...
<a id="21-phase-4-security--csrf-hardening"></a>
...
<a id="22-phase-4-security--session-cookie-hardening"></a>
...
<a id="23-phase-4-security--view-escaping-helpers"></a>
...
## 26. Phase 2: CLI UX — CommandBase

**Class:** `Pramnos\Console\CommandBase`

Abstract base class for all lock-guarded and interactive console commands. Application commands extend `Pramnos\Console\CommandBase` directly and inherit all infrastructure via PHP's normal inheritance chain.
...
Your application's `CommandBase` can then extend `\Pramnos\Console\CommandBase` and override only what differs (e.g. `getOrchestratorCommandName()`), so application code remains unchanged.
...
- `getOrchestratorCommandName()` returns `'daemons:start'` by default — matches the conventional orchestrator command name.
...
**Problem:** A background job queue (QueueManager, Worker, task handlers, CLI commands) is typically tightly coupled to application-specific models, controller names, namespace paths, and dashboard titles, making it hard to reuse across applications.

**Solution:** A complete, reusable queue system in `Pramnos\Queue` and `Pramnos\Console\Commands` with configurable hooks at every application-specific point. Applications subclass and override only what differs; all infrastructure is inherited.
...
```php
// Before
use YourApp\Services\Queue\QueueManager;
use YourApp\Services\Queue\Worker;

// After
use Pramnos\Queue\QueueManager;
use Pramnos\Queue\Worker;
// Override hooks to restore application-specific behaviour.
```
...
**Problem:** Process-supervision for background daemons (queue workers, Kafka consumers) is often a monolithic orchestrator tightly coupled to application-specific settings and entry-points, making it hard to reuse across applications.
...
```php
// Before (application-local):
use App\ConsoleCommands\DaemonOrchestrator;
...
- `getOrchestratorCommandName()` (inherited from `CommandBase`) returns `'daemons:start'` by default — matches the conventional command name.
...
**Problem:** The existing authserver schema had basic roles, permissions, user_roles, and audit_log tables (migrations 000020–000024) but lacked the complete RBAC infrastructure needed for a multi-organisation permission system: organisation membership, permission/role templates, object hierarchy, the effective_permissions view, and the PL/pgSQL helper functions.
...
**Problem:** Applications need descriptive lists of OAuth2 authentication methods, grant types, and webhook event types for developer-facing UIs. Maintaining these in application code creates a drift risk.
...
**Problem:** When issuing tokens, callers needed to merge the requested scopes with the server's default scopes. This logic was previously duplicated in application code.
...
**Problem:** Geographic coordinate validation and IP/CIDR validation are general-purpose utilities with no application-specific logic, but were previously implemented in application code.
...
#### Atomic counters — `FlatCache::increment()` / `decrement()` / `counter()`

`src/Pramnos/Cache/FlatCache.php`, `src/Pramnos/Cache/Adapter/{AbstractAdapter,RedisAdapter}.php`

An atomic integer-counter capability for rate limits, failed-login trackers,
spam-violation tallies and monotonic epoch markers — values that need atomic
updates under concurrency and a bare-integer representation, distinct from the
serialised value cache.

```php
$attempts = $cache->increment("login_attempts:{$ip}", 1, 900); // +1, sliding 900s TTL; returns new total
$cache->counter("login_attempts:{$ip}");                        // read (0 if absent, key not created)
$cache->decrement('slots_free');
```

- `increment(string $key, int $by = 1, null|int|\DateInterval $ttl = null): int` — returns the new total; `$ttl` resets expiry each call (sliding window).
- `decrement(...)` — mirror image.
- `counter(string $key): int` — current value, `0` when absent, does not create the key.

Fully backwards compatible: `AdapterInterface` is **unchanged**; `AbstractAdapter`
supplies a concrete non-atomic default (so every adapter gains it); `RedisAdapter`
overrides with native `INCRBY`/`DECRBY` + `EXPIRE` for real cross-process atomicity.
Counter keys are bare integers — read them with `counter()`, never `get()`. See the
[Cache Guide](Pramnos_Cache_Guide.md#atomic-counters-increment--decrement--counter).
...
## Advanced Schema Elements — Phase 2

**Status:** In Progress (v1.2-dev)

The Pramnos Framework v1.2 incorporates advanced schema elements to provide production-grade monitoring, security, and compliance features out of the box.
...
Syncs the framework schema with the reference production schema by adding indexes
...
- `idx_sessions_time` on `time`

#### users
- `idx_users_photo` on `photo` (conditional: only when `photo` column exists)

#### usertokens
- `idx_usertokens_parentToken` on `parentToken` (conditional: column must exist)
- `idx_usertokens_token` on `token` — PostgreSQL: full TEXT index; MySQL: prefix(255)

#### tokenactions
- `idx_tokenactions_tokenid` on `tokenid`
- `idx_tokenactions_urlid` on `urlid`
- `idx_tokenactions_return_status` on `return_status` (conditional: column must exist)
- `idx_tokenactions_execution_time` on `execution_time_ms` (conditional: column must exist)
- `idx_tokenactions_time_method` on `(action_time DESC, method)` (conditional: action_time column must exist)
...
1. The application is configured to use `LogDriver` pointing to a shared JSONL file
   (e.g., `var/broadcast.jsonl`).
2. `broadcast:serve` starts listening on `ws://localhost:6001` and tails the log file.
3. When a new JSON line appears in the file, the daemon parses it and pushes the
   broadcast to all WebSocket clients subscribed to that channel.
...
| `--port` / `-p` | `6001` | Listen port |
| `--log-file` | auto | Path to LogDriver JSONL file; auto-resolved from container config |
| `--app-key` | `pramnos-local` | Pusher app key expected in the WebSocket URL |
| `--verbose` / `-v` | off | Print connection count changes each tick |
...
- `Pramnos\Broadcasting\LocalBroadcastServer` — WebSocket server engine;
  `run(host, port)`, `broadcast(channel, event, data)`, `stop()`, `onTick(cb)`
- `Pramnos\Console\Commands\BroadcastServe` — Symfony console command
...
- ✅ Missing foreign keys migration (core/000050)
...
<a id="62-view--template-system--complete-guide"></a>
...
<a id="64-routergroup--routegroup"></a>
...
<a id="65-jsonresponsemiddleware--apiauthmiddleware"></a>
...
<a id="66-rest-api-scaffolding--pramnos-init---rest-api"></a>
...
<a id="67-database-driven-cors-pf-43--phase-15-convergence-test"></a>
...
The `_jsonactions` mechanism (legacy BC — appends edit/delete links to rows) is preserved. `Datasource::getList()` is no longer called from `_getJsonList()`.
...
<a id="70-authserver--logs-wiring-in-init-app"></a>
## 70. AuthServer + Logs Wiring in `init app`

**Problem:** After session 113, `auth` was wired but `authserver` (OAuth2 server) was left unwired — no controller wrapper existed to route `/oauth/authorize`, `/oauth/token` etc. Similarly, every new app should expose the log viewer at `/logs` (following a conventional thin-wrapper pattern) but no `Logs` controller was scaffolded.
...
Scaffolded for every new application (no feature flag needed). Follows a conventional thin-wrapper pattern: thin wrapper extending `\Pramnos\Application\Controllers\LogController`. Developers override `$whitelist` and `$blacklist` to control visible log files.
...
| `Pramnos\Debug\DebugBarServiceProvider` | Auto-activates in development/debug mode; uses `ob_start()` to intercept output |
...
| `TimeCollector` | `Time (123ms)` | Request wall-clock time + named timers (including migration segments) |
...
| `MigrationsCollector` | `Migrations (2 ran)` | Migrations that ran this request + full history from `schemaversion` |
...
| `recordMigration(string $slug, float $ms, string $status = 'ran'): void` | Records a migration in both timeline and Migrations tab |
...
| Condition | Notes |
|---|---|
| `APP_DEBUG` env var is set and not `'0'`/`'false'` | Standard env-based flag |
| `DEVELOPMENT` PHP constant is `true` | Defined in bootstrap |
| `'debug'` app setting is truthy | `settings.php` key `debug` |
| `'development'` app setting is truthy | `settings.php` key `development` |
...
<a id="71-scaffold--rich-settings-page-full-application-edit-user-token-management"></a>
...
- **Security** — `securitySalt` (write-only field), `loginlockoutwindowseconds`, `loginlockoutsteps` (dynamic card builder, same dynamic-card format)
...
|---|---|---|---|
| `$groupByColumn` | `int\|null` | `null` | 0-based index of the column to group by on first render. `null` = no grouping. |
| `$groupBySelector` | `bool` | `false` | When `true`, renders a column-picker `<select>` above the table so the user can change (or clear) the group-by column interactively. |
...
- **HTML** (`renderTable()`): when `$groupBySelector === true`, a `<div>` containing a `<select id="pf40_groupby_{name}">` is injected before the `<table>`. The select lists all columns that have a non-empty label. The "None" option (`value="-1"`) removes grouping.
- **JavaScript** (`renderJs()`): when grouping is active, a `pf40_doGroup_{name}()` function is registered on the DataTables `draw.dt` event. After every DataTables draw (sort, search, page change) the function scans `<tbody>` rows and inserts `<tr class="pramnos-group-row">` separator rows wherever the grouped column's value changes.
- **Change handler**: when `$groupBySelector === true`, a `change` listener on the `<select>` updates the group column variable and calls `{name}.fnDraw()` to trigger a re-group.
...
```
The `Cache` class reads this config on construction and connects to the correct adapter.
...
<a id="74--qr-code-local-generation-datatable-js-fix-view-link-session-146"></a>
...
```php
$doc->addInlineScript('$(document).ready(function(){ ... });');
```
...
1. Translates them to the legacy internal format the method already understood.
2. Returns a DataTables 1.10+ response (`draw`, `recordsTotal`, `recordsFiltered`, `data`) instead of the legacy `aaData`/`sEcho` envelope.

Legacy callers (DT 1.9) are unchanged — detection is based on the presence of `draw` without `sEcho`.

!!! warning "BC break for custom list endpoints that post-process rows"

    This is source-compatible at the method signature level but **behaviourally
    breaking** for a common application pattern: an endpoint that calls
    `Datasource::getList($table, $fields, false)` (unencoded), decorates the
    returned rows in PHP (appended action columns, links, formatted dates,
    status labels), then `json_encode()`s the result.

    Such code almost always reads and writes the **`aaData`** key:

    ```php
    $result = \Pramnos\Html\Datatable\Datasource::getList($table, $fields, false);
    foreach ($result['aaData'] as $i => $row) {   // ← no longer populated
        $row[] = '<a href="…">Edit</a>';           //    under the modern format
        $result['aaData'][$i] = $row;
    }
    return json_encode($result);
    ```

    Because `Datatable::renderJs()` (below) now makes the **client** send `draw`,
    `getList()` returns rows under **`data`**, not `aaData`. The decoration loop
    silently no-ops, rows ship with only the raw DB fields, and the grid throws
    `DataTables warning: Requested unknown parameter 'N' for row 0, column N`.

    **Fix:** read and write whichever key the framework returned:
    ...
    See the [Upgrade Guide → v1.1 → v1.2](Pramnos_Upgrade_Guide.md#datatables-server-side-ajax-aadata-data)
    for the full migration steps and a regression-test recipe.
...
| Class | Purpose |
|---|---|
| `Pramnos\Debug\Collectors\ViewsCollector` | Records view renders with template path, wall-clock time, and a `fromCache` flag |
| `Pramnos\Debug\Collectors\ModelsCollector` | Tracks model load / save / delete operations |
| `Pramnos\Debug\Collectors\ExceptionsCollector` | Captures exceptions thrown during the request |
...
```php
DebugBar::renderInfoStrip(array $memData, array $routeData): string
```

Renders a compact badge row above the tabs showing:
- **Memory** — peak usage
- **DB** — live query count + cached query count
- **Route** — matched controller action
- **Env** — development / production tag
...
|---|---|
| `Factory::getSearch()` | `pramnos_search` |
| `Factory::getForm()` | `pramnos_html_form` |
| `Factory::getJquery()` | `pramnos_jquery` |
...
There is no direct replacement (the underlying rendering helpers were retired). Application
code should use the current equivalents:

- **Search UI / datatables** → `Pramnos\Html\Datatable`
- **Form building** → the framework's form / scaffolding helpers (`Pramnos\Html\*`)
- **jQuery/asset inclusion** → the theme/asset pipeline

Verified that the reference application integration project (5 176-test suite) contains **no
references** to any of the three removed methods, so their removal has no impact there.
...
The comparison now normalises both sides — stripping the table prefix, surrounding
identifier quotes (backticks / double quotes) and whitespace, and lower-casing — before
matching. An already-present quoted/qualified PK is therefore correctly detected and left
untouched, so no duplicate bare column is added. Behaviour when the PK is genuinely absent
is unchanged (it is still prepended as before).

### Tests

- `tests/Unit/Pramnos/Application/ModelEnsurePrimaryKeyInSelectTest.php` — 6 unit tests
  (backtick- and double-quote-qualified PK detection, bare PK, wildcard/empty pass-through,
  absent-PK prepend).
- `tests/Characterization/Application/ModelListApiCharacterizationTest.php` and
  `…PostgreSQLCharacterizationTest.php` — integration test
  `testGetListWithJoinSharingPrimaryKeyColumnNameReturnsRows` reproducing the exact JOIN /
  shared-PK-column scenario on MySQL **and** PostgreSQL/TimescaleDB (the PG test runs
  against the `timescaledb` container, covering both engines).

### Discovered via

Running the reference application integration suite against `v1.2-dev`: this was a genuine regression
...
1. **JSON entries were mis-detected** — the "is this line JSON?" check tested that the last
   character is `}`, but `fgets()` keeps the trailing `\n`, so every JSON log line failed the
   check and fell back to `time()` (the current time) instead of its real timestamp.
2. **Only slash dates were parsed** — the bracketed-timestamp regex accepted only
   `[\d\/]+` (the `d/m/Y` style emitted by `Logger`), so ISO (`Y-m-d`) and dash-month
   (`d-M-Y`) timestamps — which `LogManager` and PHP's own error log emit — were not
   recognised and also fell back to `time()`.

Because unparsed entries defaulted to "now", date-range filtering silently dropped older
entries whenever the requested range was in the past — and any test exercising it only
passed while "now" happened to fall inside the hard-coded range.
...
## 73. Phase 8: Delayed Queue Capability — driver-based `DelayedQueue`

A second, sibling queue capability alongside the durable `QueueManager` work
queue: a low-latency **delayed queue** ("run this later, don't lose it") whose
backend is a pluggable driver. Applications depend on the capability, never on
Redis directly — Redis is one driver of the queue.

### Why

Some background work is not a durable, auditable, status-tracked task (what
`QueueManager` / `queueitems` model well) but a fast, ephemeral "do this in N
seconds" dispatch where the job's existence *is* its state — bot replies,
deferred deliveries, debounced work. That pattern was previously implemented
per-application directly against Redis sorted sets. It is now a first-class
framework capability with a driver seam, so the backend is swappable and the
implementation is shared and tested.

### What's new (all additive — no existing type changed)

- **`Pramnos\Queue\Contracts\QueueDriverInterface`** — the backend contract:
  `push()`, `claimDue()`, `size()`, `secondsUntilNext()`, `flush()`. Semantics are
  claim-and-remove: `claimDue()` atomically removes each returned job so competing
  workers never double-process; re-scheduling is a fresh `push()`, never a mutation.
- **`Pramnos\Queue\ReservedJob`** — the immutable, driver-agnostic value object a
  claimed job is normalised into (`id`, `type`, `payload`, `attempts`, `runAt`),
  with `toArray()` yielding the `{id,type,payload,attempts,run_at}` wire shape.
- **`Pramnos\Queue\Drivers\RedisQueueDriver`** — the low-latency default. A Redis
  sorted set scored by run-at time plus a companion payload hash; atomic
  claim-by-`ZREM`. Self-connects from config **or** reuses an injected `\Redis`
  connection factory (the same pattern as the broadcasting `RedisDriver`), and
  prefixes its own keys (no reliance on `OPT_PREFIX`) so a migrating app keeps
  byte-identical keys.
- **`Pramnos\Queue\Drivers\DatabaseQueueDriver`** — the same capability backed by a
  `delayed_jobs` table (new migration) for deployments without Redis or where jobs
  must survive a cache flush. Claim-and-remove is the SQL analogue of `ZREM`:
  `DELETE ... WHERE id = ?` with an affected-rows check, so competing pollers never
  double-process. Integer `run_at` timestamps and a TEXT payload make the round-trip
  byte-identical to Redis and dialect-transparent across MySQL and PostgreSQL.
- **`Pramnos\Queue\DelayedQueue`** — the application-facing facade. Unlike
  `QueueManager` it is **not** controller-coupled (needs only its driver), so it
  can be used in a bot, a CLI worker, or any service. Adds a reusable
  linear-backoff `retry($job, $maxAttempts, $baseDelaySeconds)` policy on top of
  the driver.
...
$queue = new DelayedQueue(new RedisQueueDriver(
    ['prefix' => 'myapp_', 'namespace' => 'jobs'],
    static fn (): \Redis => $app->redis()
));

$queue->push('send_reply', ['to' => 42], delaySeconds: 5);

foreach ($queue->claimDue(20) as $job) {
    try { handle($job->type, $job->payload); }
    catch (\Throwable $e) { $queue->retry($job); }   // 10s, 20s … then dropped at maxAttempts
}
```

### BC notes

Purely additive: `QueueDriverInterface`, `ReservedJob`, `DelayedQueue`, and
`RedisQueueDriver` are all new types under `Pramnos\Queue`. `QueueManager`,
`Worker`, and `QueueItem` are unchanged in signature and behaviour, so existing
applications (which use the durable work queue) are unaffected.

### Tests

`tests/Unit/Pramnos/Queue/RedisQueueDriverTest.php` injects an in-memory fake of
the phpredis sorted-set/hash surface through the driver's connection factory and
verifies prefixed key layout, due-only claiming, atomic claim-and-remove across
calls, size / secondsUntilNext / flush, and the facade's backoff-and-drop retry.
`tests/Integration/Queue/DelayedQueueDatabase{MySQL,PostgreSQL}Test.php` run the
database driver against live MySQL and PostgreSQL, proving the same contract holds
on a real relational backend on both dialects.

### See also

[Pramnos Queue Guide](Pramnos_Queue_Guide.md).

## 74. Phase 8: Cache atomic `swap()` (GETSET) — change detection

Extends the raw-key atomic family on the flat cache (alongside `increment()` /
`decrement()` / `counter()`) with **`swap()`**: set a key to a new value and get
the previous one back in a single atomic step — the "record only when it changed"
de-duplication primitive.

```php
$previous = $cache->swap('radio:last_track', $nowPlaying);
...
- **`FlatCache::swap(string $key, string $value): ?string`** — returns the previous
  value (null when the key was unset) and stores the new one.
- **`AbstractAdapter::swap()`** — a concrete, non-atomic read-then-write default, so
  every adapter that extends it gains the capability for free.
- **`RedisAdapter::swap()`** — overrides it with native Redis `GETSET`, genuinely
  atomic across processes.

Like the counters, the value is stored **raw** (not through the `{data,time}`
envelope), so it round-trips as a plain string — read it back with another
`swap()`, never `get()`. `AdapterInterface` is **unchanged**, so existing
third-party adapters keep working.

### Tests

`tests/Unit/Pramnos/Cache/FlatCacheTest.php` covers the unset→previous→previous
progression and the change-detection (swap-to-self) pattern.

## 75. OpenAPI docs from `#[Route]` attributes — `api:docs`

Attribute-routed apps can now generate their OpenAPI 3.0 spec straight from the
`#[Route]` attributes the router already dispatches from, so the docs never drift
from the routes. This is the attribute-native counterpart to the older
routes.php + `@api` JSDoc-comment flow.

### What's new (additive)

- **`Pramnos\Routing\OpenApiGenerator`** — reflects `#[Route]` attributes on
  controller methods (scanning a PSR-4 directory, or an explicit class list) and
  builds an OpenAPI document: paths + methods (`{param}`/`{param?}` → path
  parameters), `operationId` from the route name, `summary`/`description` from the
  handler docblock, `bearerAuth` security for routes with permissions or an auth
  middleware, and `tags` from the controller name. An `overrides` document is
  deep-merged over the result for the parts that cannot be inferred (request/
  response schemas, examples).
- **`api:docs` console command** — wraps the generator: `--controllers`,
  `--namespace` (auto-detected from app/app.php when omitted), `--output`,
  `--title`/`--version`/`--description`, repeatable `--server`, and `--overrides`.

### Example

```
php pramnos api:docs --namespace='App\Controllers' --output=www/api/openapi.json \
    --title='My API' --api-version=1.0.0 --overrides=src/openapi-overrides.json
```

### Tests

`tests/Unit/Pramnos/Routing/OpenApiGeneratorTest.php` (docblock parsing, path
params, security derivation, overrides merge) and
`tests/Unit/Pramnos/Console/Commands/ApiDocsTest.php` (end-to-end file generation).

### See also

[Pramnos Routing Guide](Pramnos_Routing_Guide.md) — "OpenAPI documentation from `#[Route]`".

## 76. Services-oriented app style — `create:service`, SPA scaffolding, styles guide

First-class support for building apps as a **JSON API + services + JS SPA**,
alongside the classic MVC + Models style — so an app whose logic is richer than
CRUD (rate limiting, moderation, real-time, background jobs) has a documented,
tooled path that does not force ActiveRecord.

### What's new (additive)

- **`create:service` command** (+ `service.stub`) — scaffolds `src/Services/<Name>.php`:
  a plain class with an injectable `Database` and a QueryBuilder example, plus a
  matching test stub. The services-oriented counterpart to `create:model`.
- **SPA scaffolding stubs** — `spa-index.html.stub` (HTML shell) and
  `spa-app.js.stub` (a small `fetch()` API client + boot) as starting points for a
  static single-page front end that consumes the JSON API.
- **[Application Styles guide](Pramnos_Application_Styles_Guide.md)** — documents
  the two styles side by side (MVC + Models vs Services + API + SPA), when to use
  each, why services instead of models, attribute routing, `api:docs`, and the SPA
  layout. Pairs with feature 75 (OpenAPI from `#[Route]`).

### Tests

`tests/Unit/Console/MakeCommandGeneratorsTest.php::testCreateService` covers the
generated file (namespace, class, injectable Database, table guess) and its test stub.

## 77. Phase 8: central Redis ConnectionManager + drivers fall onto it

One place that opens \Redis connections, so the cache, broadcasting and queue
Redis drivers — and applications — stop each re-rolling connect/auth/select.

- **`Pramnos\Redis\ConnectionManager`** — `connection()` (shared, lazy),
  `newConnection()` (fresh, for a blocking SUBSCRIBE), `prefix()` + config
  getters. Fail-fast connect/auth. Default instance resolves from native env
  (`REDIS_*` via `envvar()`) or a `redis` settings section; overridable per app
  via `setInstance()`. Connection factory injectable for tests / reuse.
- **Drivers wired onto it (additive/BC):** `Cache\Adapter\RedisAdapter`,
  `Broadcasting\Drivers\RedisDriver` and `Queue\Drivers\RedisQueueDriver` now
  create connections through a ConnectionManager built from their own config
  (each still honours its config and its injected factory).
- **`Health\Checks\RedisConnectivityCheck`** — native Redis health check (PING via
  the manager), beside the built-in database/disk/memory checks.

Tests: ConnectionManagerTest, RedisConnectivityCheckTest (fake connection via the
injectable factory). See [Pramnos Redis Guide](Pramnos_Redis_Guide.md).

## 78. Phase 8: structured cache operations (hash / list / enumeration)

Extends the flat cache with Redis-style structured operations, so data that is a
cache but needs a *shape* (a bounded recent-items list, a field-addressed map, an
enumerable keyspace) can stay in the Cache capability instead of dropping to raw
Redis. Same layered, backwards-compatible design as the counters/swap family.

### What's new (all additive; AdapterInterface unchanged)

- **`FlatCache`**: `hashSet/hashGet/hashDelete/hashGetAll`, `listPush/listTrim/
  listRange`, `expire`, `keys`. Field/element values are serialised (any value
  round-trips); `keys()` returns logical keys (cache prefix stripped).
- **`AbstractAdapter`**: concrete non-atomic fallbacks that keep the whole
  structure under one key via load/save (so every adapter gains the capability);
  list ops follow Redis LPUSH/LTRIM/LRANGE semantics (newest-first, inclusive,
  negative indices).
- **`RedisAdapter`**: native overrides — `HSET/HGET/HDEL/HGETALL`, `LPUSH/LTRIM/
  LRANGE`, `EXPIRE`, and `SCAN` for `keys()`.

### Why

App state such as a recent-message history (a bounded list cached from the DB),
reply/tombstone maps (hashes) and TTL'd markers is genuinely cache — it only
reached for raw Redis because the cache lacked list/hash/enumeration. Now it goes
through the capability with Redis as the driver.

### Tests

`tests/Unit/Pramnos/Cache/FlatCacheTest.php` covers hash round-trip/delete, list
push/range/trim (incl. negative indices and structured values), and the keys()
contract via the in-memory adapter (fallback path).

## 79. Auto-migration: app-declared directories + standalone `migrate()`

Auto-run migrations are no longer limited to the framework feature directories,
and no longer require the full `init()`/`exec()` request lifecycle — so an app
using attribute routing (or a console bootstrap) gets auto-migration on every
execution as ready infrastructure.

### What's new (all additive; existing apps unchanged)

- **App-declared migration directories** — `app.php` `'migrations' => ['paths' =>
  [...]]` lists application-owned migration dirs that auto-run scans *in addition
  to* the framework feature dirs, on the same fingerprint fast-path. An app
  baseline placed there auto-runs like any framework migration.
- **Framework opt-out** — `'migrations' => ['framework' => false]` skips the
  framework feature directories entirely, so an app whose schema collides with a
  framework table (e.g. its own `sessions` layout) runs only its own `paths`.
  Defaults to `true` (unchanged for existing apps).
- **`Application::migrate()`** — public standalone entry point: connects the DB if
  needed (no session start, addons or session tracking), honours the same
  `migrations`/`migration_cutoff`/`features` config, runs the fingerprint
  fast-path auto-migration, and **never throws** (failures are logged).
- **On-demand cross dependencies** — `MigrationRunner::setDependencyPool()` lets a
  migration in the batch declare `$dependencies` on a migration that is *not* in
  the batch (e.g. a framework migration under `framework => false`, or a gated
  feature): the runner pulls it — transitively — from
  `Application::frameworkMigrationPool()` (all framework migrations, un-gated, by
  slug) and orders it first, instead of failing "unknown dependency". So an app
  adopts exactly the framework table/feature it depends on, and nothing else.
  Wired on both the auto-run and the explicit `migrate` command; the pool loads
  lazily, only when a missing dependency is hit.

### Why

Applications that deliberately do not adopt the framework's MVC request
lifecycle (attribute-routed front controllers, custom bootstraps) still want the
"migrations apply themselves on every deploy/request" guarantee — and an app that
manages a schema overlapping a framework table needs to run its own migrations
without the framework's colliding ones. Both are now first-class, config-driven.

### Tests

`tests/Unit/Pramnos/Application/ApplicationAppMigrationsTest.php` (config
resolution + BC defaults) and the app-declared / framework-off / public-`migrate()`
cases added to the MySQL + PostgreSQL `ApplicationAutoMigrations*Test` integration
suites. See [Pramnos Migration Guide](Pramnos_Migration_Guide.md).

## 80. Capability default accessors on the ConnectionManager + DB session timezone

The Redis-backed capabilities (cache, broadcast, queue) can now be obtained
pre-wired from the shared `Pramnos\Redis\ConnectionManager`, so an application
configures the manager once (`ConnectionManager::setInstance()` in bootstrap) and
gets the capabilities without re-building adapters/drivers itself.

### What's new (all additive; nothing changes for apps that don't call them)

- **`FlatCache::default()` / `FlatCache::setDefault(?FlatCache)`** — a lazy,
  process-default flat cache: a `RedisAdapter` bound to the ConnectionManager's
  host/port/database/password and per-install prefix (verbatim colon-keys).
  `setDefault()` is the bootstrap/test-reset seam.
- **`BroadcastingManager::instance()` / `setInstance(?self)`** — a lazy default
  manager pre-wired with a `RedisDriver` on the ConnectionManager (its prefix +
  pooled connection) and `redis` as the active driver. Named `instance()` (not
  `default()`) to avoid clashing with the existing `setDefault(string)` driver
  selector.
- **`DelayedQueue::redis(string $namespace)`** — a factory returning a
  Redis-backed delayed queue for a namespace, bound to the ConnectionManager
  (`<prefix><namespace>:delayed`/`:data`). A queue is namespaced-per-use, so this
  is a factory rather than a singleton.
- **`Database` session timezone** — a new `database.timezone` setting (default
  unset). When set, the framework issues `SET TIME ZONE` (PostgreSQL) /
  `SET time_zone` (MySQL) **per connection** on connect; unset ⇒ no SET, so the
  connect path is byte-identical for existing apps.

All accessors resolve `ConnectionManager::getInstance()` lazily inside the method
body (never at class-load), so an app that binds the manager during bootstrap is
always in effect. The cache adapter keeps its own dedicated connection (as
before); broadcast/queue publish over the manager's shared `connection()`.

### Why

Before this, every app re-implemented the same wiring (build a `FlatCache` +
`RedisAdapter` from a prefix, register a `RedisDriver`, construct a
`RedisQueueDriver`) and issued its own `SET timezone`. Centralising it on the
ConnectionManager makes "configure Redis once, use the capabilities anywhere" the
default, and lets an app's own capability classes shrink to policy-only.

### Tests

`FlatCacheTest` (default lazy-singleton + prefix wiring), `BroadcastingManagerTest`
(`instance()` publishes to the prefixed channel over an injected fake connection),
`DelayedQueueTest` (`redis()` prefix/namespace/connection wiring), and
`DatabaseTimezonePostgreSQLTest` (configured zone applied, config-driven, unset =
server default). See the Cache, Redis, Queue, Realtime and Database guides.

## 81. Init-less test database helper

`Pramnos\Framework\Testing\TestDatabase` — a standalone test-DB helper that
provides a raw `\PDO` connection (from the `database` settings, honouring
`database.timezone`) plus `assertDatabaseHas()` / `assertDatabaseMissing()`,
**without** running the MVC request lifecycle.

### Why

`BaseTestCase::setUp()` boots `Application::init()` (session start, session
tracking, addons) — the right thing for MVC apps, but wrong for "Services + API +
SPA" apps that never call `init()` (and whose own `sessions` schema collides with
the framework's session tracking). Those apps still want a simple way to seed the
real database with plain SQL. `TestDatabase` gives them the connection + seams
(`setConnection`/`reset`) + row assertions, with no lifecycle.

### Tests

`tests/Integration/Database/TestDatabaseHelperTest.php` (connection from settings +
memoisation, row assertions against real PostgreSQL, setConnection/reset seams).
See [Pramnos Testing Guide](Pramnos_Testing_Guide.md).

## 82. DaemonOrchestrator::status() — read-only health snapshot

`Pramnos\Console\DaemonOrchestrator` gains a public `status()` returning the
orchestrator's own liveness (`running`/`pid` from the singleton lock),
`heartbeat_age_seconds` (age of the per-cycle state file), and its managed
`daemons` (last-persisted state, each enriched with live process status) —
**without** running a reconcile cycle.

### Why

The orchestrator was a fire-and-forget supervising loop with no queryable state,
so an app that adopted it still had to keep a separate legacy supervisor just to
report "is the supervisor up?" to a dashboard — which, since it was no longer the
process actually running, reported stale/wrong health. `status()` lets the
dashboard read the real orchestrator directly: `(new MyOrchestrator())->status()`.

### Tests

`tests/Unit/Console/DaemonOrchestratorTest.php` — running/pid/heartbeat/daemons
with a live lock pid, not-running with a dead lock pid, and the safe no-lock/no-state
case. See [Pramnos Console Guide](Pramnos_Console_Guide.md).
