...
43 characterization tests in `tests/Characterization/Application/OrmModelCharacterizationTest.php` covering all features above (pure unit tests, no DB required).
