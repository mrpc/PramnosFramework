...
- [26. Phase 2: CLI UX — CommandBase (Backport από the reference application)](#26-phase-2-cli-ux-commandbase-backport-the reference application)
...
- [the reference application Schema Backport — Phase 2](#the reference application-schema-backport-phase-2)
...
## 26. Phase 2: CLI UX — CommandBase (Backport από the reference application)

**Class:** `Pramnos\Console\CommandBase`

Abstract base class for all lock-guarded and interactive console commands. Backported from `App\ConsoleCommands\CommandBase`. the reference application commands can now extend `Pramnos\Console\CommandBase` directly and inherit all infrastructure via PHP's normal inheritance chain.
...
**Solution:** Full backport to `Pramnos\Queue` and `Pramnos\Console\Commands` with configurable hooks at every the reference application-specific point. Applications subclass and override only what differs; all infrastructure is inherited.
...
## the reference application Schema Backport — Phase 2
