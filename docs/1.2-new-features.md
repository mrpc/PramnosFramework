...
| File | Coverage |
|---|---|
| `tests/Unit/Health/HealthControllerTest.php` | 14 unit tests: class hierarchy, public/auth actions, HealthRegistry::runAll() shape, display() HTML (ok badge, down badge, check list, empty state, system info), check() HTTP code mapping, admin.health NavItem |
