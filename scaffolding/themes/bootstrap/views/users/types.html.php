<?php
/**
 * What each user type is, and what it may do (Bootstrap theme).
 *
 * Variables:
...
$toneCls = ['danger' => 'bg-danger text-white', 'warning' => 'bg-warning', 'neutral' => 'bg-secondary text-white', 'primary' => 'bg-info text-white'];
?>
<div class="container-fluid py-4">
                    ...
                    <tr>
                        ...
                        <td class="text-xs">
                            ...
                            <?php else: ?>
                                ...
                                <code class="badge bg-light text-dark"><?php echo $e($capability); ?></code>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </td>
                        <td class="text-xs">
                            <?php if (in_array('*', $all, true)): ?>
                            <span class="badge bg-danger">everything</span>
                            <?php else: ?>
                            <span class="text-muted"><?php echo count($all); ?> capabilit<?php echo count($all) === 1 ? 'y' : 'ies'; ?></span>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
    ...
    <div class="row g-3">
        <div class="col-md-6"><div class="card card-body small>
