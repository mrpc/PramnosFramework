...
<div class="container py-4">
        ...
        <div class="p-5">
            <form method="post" action="<?php echo adminUrl('Users/save'); ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="username" class="form-control form-control-sm" required value="<?php echo htmlspecialchars($u['username'] ?? ''); ?>">
                </div>
                <div class="mb-3">
                    <label class="block text-sm font-medium text-base-content mb-1">Email</label>
                    <input type="email" name="email" class="form-control form-control-sm" required value="<?php echo htmlspecialchars($u['email'] ?? ''); ?>">
                </div>
                <?php if ($this->isNew): ?>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="firstname" class="form-control form-control-sm" value="<?php echo htmlspecialchars($u['firstname'] ?? ''); ?>">
                </div>
                <div class="mb-3">
                    <label class="block text-sm font-medium text-base-content mb-1">Last Name</label>
                    <input type="text" name="lastname" class="form-control form-control-sm" value="<?php echo htmlspecialchars($u['lastname'] ?? ''); ?>">
                </div>
                <div class="grid gap-4 md:grid-cols-2 mb-4">
                    <div>
                        <label class="block text-sm font-medium text-base-content mb-1">Phone</label>
                        <input type="text" name="phone" class="form-control form-control-sm" value="<?php echo $e($u['phone'] ?? ''); ?>">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-base-content mb-1">Mobile</label>
                        <input type="text" name="mobile" class="form-control form-control-sm" value="<?php echo $e($u['mobile'] ?? ''); ?>">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-base-content mb-1">Language</label>
                        <input type="text" name="language" class="form-control form-control-sm" placeholder="en"
                               value="<?php echo $e($u['language'] ?? ''); ?>">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-base-content mb-1">Timezone</label>
                        <input type="text" name="timezone" class="form-control form-control-sm" placeholder="Europe/Athens"
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?php echo adminUrl('Users'); ?>" class="btn btn-sm btn-outline-secondary ">Cancel</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="card bg-base-100 border border-base-300 shadow-xs mt-4">
        ...
        <form method="post" action="<?php echo adminUrl('users/savesetting/' . $uid); ?>"
            ...
            <div>
                ...
                <input type="text" id="pf-setting-name" name="setting" class="form-control form-control-sm"
            ...
            <div>
                ...
                <input type="text" id="pf-setting-value" name="value" class="form-control form-control-sm"
    ...
    <div class="card bg-base-100 border border-base-300 shadow-xs mt-4">
            ...
            <?php foreach ($grants as $grant): ?>
                <tr>
                    <td class="font-mono text-xs">
                        ...
                        <span class="text-muted small">#<?php echo $e($grant['object_id']); ?></span>
                        <?php endif; ?>
                    </td>
        ...
        <form method="post" action="<?php echo adminUrl('users/grantpermission/' . $uid); ?>"
            ...
            <div>
                ...
                <input type="text" name="object_type" class="form-control form-control-sm" placeholder="report" required>
            </div>
            <div>
                <label class="block text-xs font-medium mb-1">Object id</label>
                <input type="text" name="object_id" class="form-control form-control-sm" placeholder="optional">
            </div>
            <div>
                <label class="block text-xs font-medium mb-1">Action</label>
                <input type="text" name="action" class="form-control form-control-sm" placeholder="read" required>
            </div>
            <div>
                <label class="block text-xs font-medium mb-1">Grant</label>
                <select name="grant_type" class="form-select form-select-sm">
    ...
    <div class="mt-4 flex flex-wrap gap-2">
        <a href="<?php echo adminUrl('users/view/' . $uid); ?>" class="btn btn-sm btn-outline-secondary  gap-2">
            <?php echo \Pramnos\Html\Icon::svg('view'); ?> Back to the record
        </a>
        <a href="<?php echo adminUrl('users/notify/' . $uid); ?>" class="btn btn-sm btn-outline-secondary  gap-2">
