<?php
/**
 * One template, read-only, with a test send (Bootstrap theme).
 *
 * Variables:
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
        <a href="<?php echo adminUrl('MailTemplates'); ?>" class="btn btn-sm btn-outline-secondary">&larr; Back</a>
        <h2 class="mb-0"><?php echo $e($t['title'] ?? ''); ?></h2>
        <span class="badge bg-light text-dark"><?php echo $e($types[(int) ($t['type'] ?? 0)] ?? ''); ?></span>
        <span class="badge bg-light text-dark"><?php echo $e($t['language'] ?? ''); ?></span>
        <a href="<?php echo adminUrl('MailTemplates/edit/') . $id; ?>" class="btn btn-sm btn-primary ms-auto d-inline-flex align-items-center gap-1">
    ...
    <div class="grid gap-4 lg:grid-cols-3">
        ...
        <div class="space-y-4">
            <div class="card">
                <div class="card-header fw-semibold">Placeholders</div>
                <div class="p-4">
                    <?php if ($holds === []): ?>
            ...
            <div class="card">
                <div class="card-header fw-semibold">Send a test</div>
                <form method="post" action="<?php echo adminUrl('MailTemplates/test/') . $id; ?>" class="p-4">
                    ...
                    <input type="email" id="pf-test-address" name="address" class="form-control form-control-sm mb-2" required
                           placeholder="you@example.com">
                    <button type="submit" class="btn btn-sm btn-outline-secondary w-100 d-inline-flex align-items-center justify-content-center gap-1">
            ...
            <div class="card">
                <div class="card-header fw-semibold">Lookup key</div>
