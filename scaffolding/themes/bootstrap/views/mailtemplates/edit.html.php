<?php
/**
 * Template editor (Bootstrap theme).
 *
 * Variables:
...
<div class="container py-4">
    ...
    <h2 class="mb-3"><?php echo $this->isNew ? 'New template' : 'Edit template'; ?></h2>
    ...
    <form method="post" action="<?php echo adminUrl('MailTemplates/save'); ?>"
        ...
        <div class="p-5 grid gap-4">
            <div>
                ...
                <input type="text" id="pf-tpl-title" name="title" class="form-control form-control-sm" required
            ...
            <fieldset class="border border-base-300 rounded-box p-4">
                ...
                <div class="grid gap-3 md:grid-cols-3">
                    <div>
                        ...
                        <input type="text" id="pf-tpl-category" name="category" class="form-control form-control-sm" required
                    ...
                    <div>
                        ...
                        <input type="text" id="pf-tpl-language" name="language" class="form-control form-control-sm"
                               placeholder="en" value="<?php echo $e($t['language'] ?? 'en'); ?>">
                    </div>
                    <div>
                        <label class="block text-xs font-medium mb-1" for="pf-tpl-type">Channel</label>
                        <select id="pf-tpl-type" name="type" class="form-select form-select-sm">
            ...
            <div>
                ...
                <input type="text" id="pf-tpl-subject" name="defaultsubject" class="form-control form-control-sm"
            ...
            <div>
                ...
                <textarea id="pf-tpl-body" name="defaulttext" class="form-control font-monospace small" rows="14"
                ...
                <p class="text-xs text-base-content/60 mt-1">
                    ...
                    <?php else: ?>
                        ...
                        <code class="badge bg-light text-dark">{<?php echo $e($placeholder); ?>}</code>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </p>
            </div>
            ...
            <details class="border border-base-300 rounded-box p-4">
                ...
                <div class="grid gap-3 md:grid-cols-3 mt-3">
                    <div>
                        ...
                        <input type="text" id="pf-tpl-wrapper" name="emailtemplate" class="form-control form-control-sm"
                    ...
                    <div>
                        ...
                        <select id="pf-tpl-method" name="sendmethod" class="form-select form-select-sm">
                    ...
                    <div>
                        ...
                        <input type="text" id="pf-tpl-sound" name="sound" class="form-control form-control-sm"
        ...
        <div class="px-5 py-4 border-t border-base-300 flex gap-2">
            ...
            <a href="<?php echo adminUrl('MailTemplates'); ?>" class="btn btn-sm btn-outline-secondary">Cancel</a>
            <?php if (!$this->isNew): ?>
            <a href="<?php echo adminUrl('MailTemplates/view/') . $id; ?>" class="btn btn-sm btn-link ms-auto">
                Preview &amp; test
            </a>
            <?php endif; ?>
        </div>
