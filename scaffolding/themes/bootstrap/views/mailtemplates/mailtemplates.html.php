<?php
/**
 * Message templates, grouped by notification (Bootstrap theme).
 *
 * Variables:
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
        ...
        <span class="badge bg-secondary"><?php echo count($groups); ?></span>
        <a href="<?php echo adminUrl('MailTemplates/edit'); ?>" class="btn btn-sm btn-primary ms-auto d-inline-flex align-items-center gap-1">
        ...
        <?php foreach ($groups as $key => $rows): ?>
            ...
            <div class="card">
                <div class="card-header d-flex flex-wrap align-items-center gap-2">
                    ...
                    <span class="badge bg-light text-dark"><?php echo $e($types[$type] ?? $type); ?></span>
