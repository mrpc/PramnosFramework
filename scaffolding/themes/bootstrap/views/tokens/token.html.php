<?php
/**
 * One token, everything about it (Bootstrap theme).
 *
 * Variables:
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
        ...
        <h2 class="mb-0">Token #<?php echo $id; ?></h2>
        <span class="pf-state <?php echo $status === 1 ? 'pf-state-on' : 'pf-state-off'; ?>">
            <?php echo $status === 1 ? 'Active' : 'Revoked'; ?>
        </span>
        <div class="ms-auto d-flex gap-2">
            <?php if ($uid > 0): ?>
            <a href="<?php echo adminUrl('users/view/' . $uid); ?>" class="btn btn-sm btn-outline-secondary d-inline-flex align-items-center gap-1">
            ...
            <?php if ($status === 1): ?>
            <a href="<?php echo adminUrl('Tokens/revoke/' . $id); ?>" class="btn btn-sm btn-outline-danger d-inline-flex align-items-center gap-1"
    ...
    <div class="row g-3 mb-3">
        <div class="col-lg-6"><div class="card>
            <div class="card-header fw-semibold">The token</div>
            <div class="card-body">
                <?php
        ...
        <div class="col-lg-6"><div class="card>
            <div class="card-header fw-semibold">Who and what</div>
            <div class="card-body">
                <?php
                $field('User', $uid > 0
    ...
    <div class="card>
        <div class="card-header d-flex align-items-center gap-2">
            ...
            <span class="badge bg-secondary"><?php echo (int) ($page['total'] ?? 0); ?></span>
