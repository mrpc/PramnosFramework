        ...
        <form method="POST" action="<?php echo sURL; ?>Device" class="text-left space-y-4">
            ...
            <div>
                ...
                <input type="text" id="user_code" name="user_code"
                       class="w-full border border-gray-300 rounded-md px-3 py-2 text-center font-mono text-xl font-bold uppercase tracking-widest focus:outline-hidden focus:ring-2 focus:ring-green-500"
