...
<div class="max-w-4xl mx-auto py-6 px-4">
    ...
    <div class="card bg-base-100 border border-base-300 shadow-xs mb-4">
        <div class="p-5">
            <dl >
                <dt class="font-semibold text-base-content/80 text-sm w-40 inline-block">User</dt>
                <dd class="inline"><?php echo htmlspecialchars((string)($a['username'] ?? '')); ?><?php echo !empty($a['email']) ? ' (' . htmlspecialchars((string)$a['email']) . ')' : ''; ?></dd>
                <div class="block"></div>
                <dt class="font-semibold text-base-content/80 text-sm w-40 inline-block">Endpoint</dt>
                <dd class="inline"><code><?php echo htmlspecialchars((string)($a['endpoint'] ?? ('url #' . (int)($a['urlid'] ?? 0)))); ?></code></dd>
                <div class="block"></div>
                <dt class="font-semibold text-base-content/80 text-sm w-40 inline-block">Method</dt>
                <dd class="inline"><?php echo htmlspecialchars((string)($a['method'] ?? '')); ?></dd>
                <div class="block"></div>
                <dt class="font-semibold text-base-content/80 text-sm w-40 inline-block">HTTP Status</dt>
                <dd class="inline"><?php echo $a['return_status'] !== null ? (int)$a['return_status'] : '—'; ?></dd>
                <div class="block"></div>
                <dt class="font-semibold text-base-content/80 text-sm w-40 inline-block">Execution Time</dt>
                <dd class="inline"><?php echo $a['execution_time_ms'] !== null ? number_format((float)$a['execution_time_ms'], 2) . ' ms' : '—'; ?></dd>
                <div class="block"></div>
                <dt class="font-semibold text-base-content/80 text-sm w-40 inline-block">Token</dt>
                ...
                <dt class="font-semibold text-base-content/80 text-sm w-40 inline-block">IP Address</dt>
    ...
    <div class="card bg-base-100 border border-base-300 shadow-xs mb-4">
        <div class="px-5 py-3 bg-base-200 border-b border-base-300 font-semibold text-sm">Request Params</div>
    ...
    <div class="card bg-base-100 border border-base-300 shadow-xs">
        <div class="px-5 py-3 bg-base-200 border-b border-base-300 font-semibold text-sm">Response Data</div>
        <div class="p-5"><pre class="text-sm" style="white-space:pre-wrap;word-break:break-all"><?php
