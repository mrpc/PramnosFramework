            ...
            <table class="w-full text-sm">
                ...
                <?php foreach (($this->actions ?? []) as $a): ?>
                    <tr>
                        ...
                        <td><a href="<?php echo sURL; ?>TokenActions/show/<?php echo (int)$a['id']; ?>" class="px-3 py-1 border border-gray-300 text-gray-700 text-xs rounded-sm hover:bg-gray-50">View</a></td>
                    </tr>
                <?php endforeach; ?>
