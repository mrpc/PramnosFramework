        ...
        <div class="p-5">
            <form method="post" action="<?php echo sURL; ?>Users/save">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="username" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-sm" required value="<?php echo htmlspecialchars($u['username'] ?? ''); ?>">
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                    <input type="email" name="email" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-sm" required value="<?php echo htmlspecialchars($u['email'] ?? ''); ?>">
                </div>
                <?php if ($this->isNew): ?>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Password</label>
                    <input type="password" name="password" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-sm" required>
                </div>
                <?php endif; ?>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-1">First Name</label>
                    <input type="text" name="firstname" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-sm" value="<?php echo htmlspecialchars($u['firstname'] ?? ''); ?>">
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Last Name</label>
                    <input type="text" name="lastname" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-sm" value="<?php echo htmlspecialchars($u['lastname'] ?? ''); ?>">
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-1">User Type</label>
                    <select name="usertype" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-sm">
