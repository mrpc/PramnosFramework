<?php
/**
 * One token, everything about it (Tailwind theme).
 *
 * Variables:
...
<div class="px-4 py-6">
    ...
    <div class="flex flex-wrap items-center gap-3 mb-4">
        <a href="<?php echo adminUrl('Tokens'); ?>" class="btn btn-outline btn-xs">&larr; Back</a>
        <h2 class="text-lg font-semibold">Token #<?php echo $id; ?></h2>
    ...
    <div class="grid gap-4 lg:grid-cols-2 mb-4">
        <div class="card bg-base-100 border border-base-300 shadow-xs">
            <div class="px-5 py-3 bg-base-200 border-b border-base-300 font-semibold text-sm">The token</div>
            <div class="px-5 py-3">
                <?php
        ...
        <div class="card bg-base-100 border border-base-300 shadow-xs">
            <div class="px-5 py-3 bg-base-200 border-b border-base-300 font-semibold text-sm">Who and what</div>
            <div class="px-5 py-3">
                <?php
                $field('User', $uid > 0
    ...
    <div class="card bg-base-100 border border-base-300 shadow-xs overflow-hidden">
        ...
        <div class="px-5 py-3 border-t border-base-300 flex gap-2 items-center text-sm">
            ...
            <a class="btn btn-outline btn-xs" href="<?php echo adminUrl('Tokens/view/' . $id) . '?page=' . ((int) $page['page'] - 1) . '&limit=' . (int) $page['limit']; ?>">&lsaquo; Previous</a>
            <?php endif; ?>
            <?php if ((int) $page['page'] < (int) $page['pages']): ?>
            <a class="btn btn-outline btn-xs" href="<?php echo adminUrl('Tokens/view/' . $id) . '?page=' . ((int) $page['page'] + 1) . '&limit=' . (int) $page['limit']; ?>">Next &rsaquo;</a>
            <?php endif; ?>
        </div>
        <?php endif; ?>
        <?php endif; ?>
