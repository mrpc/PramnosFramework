...
<div class="container mx-auto py-10 px-4">
    ...
    <div class="bg-blue-100 border border-blue-300 text-blue-800 rounded-sm p-4 mb-6">
        <strong>OAuth2 Server</strong> — This is the default OAuth2 view. A specific template was not found for the requested action.
    </div>
    <a href="<?php echo adminUrl('Dashboard'); ?>" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-md mr-2 transition-colors">Dashboard</a>
