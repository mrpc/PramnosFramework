        ...
        <div class="p-5">
            <form method="post" action="<?php echo adminUrl('settings/save'); ?>">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="key" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-sm" required
                        value="<?php echo htmlspecialchars($this->key ?? ''); ?>"
                        <?php echo !$this->isNew ? 'readonly' : ''; ?>>
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Value</label>
                    <textarea name="value" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-sm" rows="4"><?php echo htmlspecialchars($this->value ?? ''); ?></textarea>
                </div>
                <div class="flex gap-2">
                    ...
                    <a href="<?php echo adminUrl('settings/list'); ?>" class="px-4 py-2 border border-gray-300 text-gray-700 text-sm rounded-sm hover:bg-gray-50">Cancel</a>
                </div>
            </form>
        </div>
    </div>
