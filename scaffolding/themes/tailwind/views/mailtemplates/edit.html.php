<?php
/**
 * Template editor (Tailwind theme).
 *
 * Variables:
 *   $this->template     — the row (empty when creating)
 *   $this->isNew        — bool
 *   $this->types        — channel number => label
 *   $this->placeholders — the {names} this message offers
 *   $this->categoryNote — when this mail is sent, for a category the framework declares
 *
...
<div class="max-w-4xl mx-auto py-6 px-4">
    ...
    <h2 class="text-lg font-semibold mb-4"><?php echo $this->isNew ? 'New template' : 'Edit template'; ?></h2>

    <form method="post" action="<?php echo adminUrl('MailTemplates/save'); ?>"
          class="card bg-base-100 border border-base-300 shadow-xs">
        ...
        <div class="p-5 grid gap-4">
            <div>
                ...
                <input type="text" id="pf-tpl-title" name="title" class="input input-sm w-full" required
            ...
            <fieldset class="border border-base-300 rounded-box p-4">
                ...
                <div class="grid gap-3 md:grid-cols-3">
                    <div>
                        ...
                        <input type="text" id="pf-tpl-category" name="category" class="input input-sm w-full" required
                    ...
                    <div>
                        ...
                        <input type="text" id="pf-tpl-language" name="language" class="input input-sm w-full"
                               placeholder="en" value="<?php echo $e($t['language'] ?? 'en'); ?>">
                    </div>
                    <div>
                        <label class="block text-xs font-medium mb-1" for="pf-tpl-type">Channel</label>
                        <select id="pf-tpl-type" name="type" class="select select-sm w-full">
            ...
            <div>
                ...
                <input type="text" id="pf-tpl-subject" name="defaultsubject" class="input input-sm w-full"
            ...
            <div>
                ...
                <textarea id="pf-tpl-body" name="defaulttext" class="textarea w-full font-mono text-xs" rows="14"
                ...
                <p class="text-xs text-base-content/60 mt-1">
                    ...
                    <?php endif; ?>
                    <?php if ($note !== ''): ?>
                    <br><span class="text-base-content/70"><?php echo $e($note); ?></span>
                    <?php endif; ?>
                    <br><span class="text-base-content/70">Leave a field empty to keep the
                    built-in text for it.</span>
                </p>
            </div>
            ...
            <details class="border border-base-300 rounded-box p-4">
                ...
                <div class="grid gap-3 md:grid-cols-3 mt-3">
                    <div>
                        ...
                        <input type="text" id="pf-tpl-wrapper" name="emailtemplate" class="input input-sm w-full"
                    ...
                    <div>
                        ...
                        <select id="pf-tpl-method" name="sendmethod" class="select select-sm w-full">
                    ...
                    <div>
                        ...
                        <input type="text" id="pf-tpl-sound" name="sound" class="input input-sm w-full"
        ...
        <div class="px-5 py-4 border-t border-base-300 flex gap-2">
            ...
            <?php if (!$this->isNew): ?>
            <a href="<?php echo adminUrl('MailTemplates/view/') . $id; ?>" class="btn btn-ghost btn-sm ms-auto">
                Preview &amp; test
            </a>
            <?php endif; ?>
        </div>
