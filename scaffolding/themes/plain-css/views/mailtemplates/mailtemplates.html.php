<?php
/**
 * Message templates, grouped by notification (plain-CSS theme).
 *
 * Variables:
...
<div class="page-section">
    ...
    <div style="display:flex;flex-wrap:wrap;align-items:center;gap:10px;margin-bottom:14px">
        ...
        <a href="<?php echo adminUrl('MailTemplates/edit'); ?>" class="btn btn-sm" style="margin-left:auto">
    ...
    <div class="grid gap-3">
        <?php foreach ($groups as $key => $rows): ?>
            ...
            <div class="card" style="border:1px solid #ddd;border-radius:4px">
                <div style="padding:10px 16px;background:#f5f5f5;border-bottom:1px solid #ddd;display:flex;flex-wrap:wrap;align-items:center;gap:8px">
