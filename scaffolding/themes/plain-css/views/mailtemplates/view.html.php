<?php
/**
 * One template, read-only, with a test send (plain-CSS theme).
 *
 * Variables:
...
<div class="page-section">
    ...
    <div style="display:flex;flex-wrap:wrap;align-items:center;gap:10px;margin-bottom:14px">
        ...
        <h2 style="margin:0"><?php echo $e($t['title'] ?? ''); ?></h2>
        ...
        <a href="<?php echo adminUrl('MailTemplates/edit/') . $id; ?>" class="btn btn-sm" style="margin-left:auto">
    ...
    <div class="grid gap-4 lg:grid-cols-3">
        <div class="lg:col-span-2 card bg-base-100 border border-base-300 shadow-xs overflow-hidden">
            <div style="padding:10px 16px;background:#f5f5f5;border-bottom:1px solid #ddd;font-weight:600;font-size:0.9em">
                Subject &amp; body
            </div>
        ...
        <div class="space-y-4">
            <div class="card" style="border:1px solid #ddd;border-radius:4px">
                <div style="padding:10px 16px;background:#f5f5f5;border-bottom:1px solid #ddd;font-weight:600;font-size:0.9em">Placeholders</div>
                <div class="p-4">
                    <?php if ($holds === []): ?>
            ...
            <div class="card" style="border:1px solid #ddd;border-radius:4px">
                <div style="padding:10px 16px;background:#f5f5f5;border-bottom:1px solid #ddd;font-weight:600;font-size:0.9em">Send a test</div>
                <form method="post" action="<?php echo adminUrl('MailTemplates/test/') . $id; ?>" class="p-4">
                    ...
                    <input type="email" id="pf-test-address" name="address" style="width:100%;padding:6px 8px;margin-bottom:8px" required
            ...
            <div class="card" style="border:1px solid #ddd;border-radius:4px">
                <div style="padding:10px 16px;background:#f5f5f5;border-bottom:1px solid #ddd;font-weight:600;font-size:0.9em">Lookup key</div>
