<?php
/**
 * Mass messages, newest first (plain-css theme).
 *
 * Variables:
...
<div style="padding:24px 16px">
    ...
    <div class="flex flex-wrap items-center gap-3 mb-4">
        ...
        <span style="background:#eee;padding:2px 8px;border-radius:10px;font-size:12px"><?php echo count($messages); ?></span>
        <a href="<?php echo adminUrl('MassMessages/edit'); ?>" class="btn btn-primary btn-sm ms-auto gap-2">
            <?php echo \Pramnos\Html\Icon::svg('edit'); ?> New message
        </a>
    </div>

    <?php if ($messages === []): ?>
    <div class="card" style="border:1px solid #ddd;border-radius:4px;padding:16px;color:#666">
    ...
    <div class="card" style="border:1px solid #ddd;border-radius:4px;margin-bottom:16px">
        <div class="overflow-x-auto">
            <table style="width:100%;border-collapse:collapse">
                <thead class="bg-base-200 text-xs pf-muted uppercase">
                    <tr>
                        <th>Subject</th>
                        <th>Channel</th>
                        <th>Created</th>
