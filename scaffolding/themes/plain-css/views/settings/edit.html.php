        ...
        <div class="card-body" style="padding:16px">
            <form method="post" action="<?php echo sURL; ?>settings/save">
                ...
                <div style="margin-bottom:12px">
                    ...
                    <input type="text" name="key" style="width:100%;padding:8px;border:1px solid #ccc;border-radius:4px;box-sizing:border-box" required
                ...
                <div style="margin-bottom:12px">
                    ...
                    <textarea name="value" style="width:100%;padding:8px;border:1px solid #ccc;border-radius:4px;box-sizing:border-box" rows="4"><?php echo htmlspecialchars($this->value ?? ''); ?></textarea>
                </div>
